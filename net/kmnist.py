...
kmnist_imgs = kmnist_imgs.reshape(-1, 784)[0:10000, :]
...
model = Network(layers = [
    ...
    Dense(200, 100, "sigmoid"),
    Dense(100, 10, "softmax")
])

model.reset()
success = model.train(X_train, y_train, X_val, y_val, epochs=1000, batch_size=256, learning_rate=10, penalty=0.2, early_stopping=30)
