...
\section{Neural Networks}
    ...
    \subsection{Backpropagation}
        ...
        \begin{proof}
            ...
            &= \frac{\partial}{\partial a^{(L)}_j} \left( - \sum_{k=0}^{n_L} \left( y_k \log(a^{(L)}_k) + (1 - y_k) \log(1 - a^{(L)}_k) \right) \right) \\
        ...
        \begin{proof}
            ...
            $$ \begin{aligned}
            \frac{\partial J(\theta)}{\partial a^{(L)}_j}
            &= \frac{\partial}{\partial a^{(L)}_j} \left( - \sum_{k=0}^{n_L} y_k \log(a^{(L)}_k) \right) \\
            &= - \frac{y_j}{a^{(L)}_j}
            \end{aligned} $$
