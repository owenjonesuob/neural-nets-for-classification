...
\section{Neural Networks}
    ...
    \subsection{Layers and Forward Propagation}
        ...
        The propagation of the original input through the layers of the network is called \textit{forward propagation}. Note that the activated output of the final layer, $\mathbf{a}^{(L)}$, is considered to be the overall output of the network.
    ...
    \subsection{Backpropagation}
        ...
        \begin{lemma}
            ...
            For all $i = 1, \ \ldots, \ n_l$ and all $j = 0, \ \ldots, \ n_{l-1}$,
