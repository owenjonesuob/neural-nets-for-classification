...
\section{Logistic Regression}
    ...
    \subsection{The Cost Function}
        ...
        A \textit{cost function} assigns a "penalty value" based on the dissimilarity between $a$ and $y$. For example, the \textit{binary cross-entropy} is defined as follows:
